...
$_lang['setting_ms2_payment_cloudpayments_currency_desc']               = 'Валюта в которой производится оплата. RUB/USD/EUR/GBP итд. Все возможные значения смотрите в документации <a target="_blank" href="https://cloudpayments.ru/Docs/Directory#currencies">https://cloudpayments.ru/Docs/Directory#currencies</a>';
$_lang['setting_ms2_payment_cloudpayments_language']                    = 'Язык интерфейса виджета';
$_lang['setting_ms2_payment_cloudpayments_language_desc']               = 'Язык интерфейса виджета (ru-RU, en-US итд.) Все возможные значения смотрите в документации <a target="_blank" href="https://cloudpayments.ru/Docs/Widget#language">https://cloudpayments.ru/Docs/Widget#language</a>';
...
$_lang['setting_ms2_payment_cloudpayments_vat_desc']                    = 'Возможные значения: 18,10,0,110,118 или пустое значение. Только для формирования онлайн-чека. Более детальная информация в документации CloudPayments <a target="_blank" href="https://cloudpayments.ru/Docs/Kassa#data-format">https://cloudpayments.ru/Docs/Kassa#data-format</a>';
$_lang['setting_ms2_payment_cloudpayments_vat_delivery']                = 'Ставка НДС для доставки';
$_lang['setting_ms2_payment_cloudpayments_vat_delivery_desc']           = 'Возможные значения: 18,10,0,110,118 или пустое значение. Только для формирования онлайн-чека. Более детальная информация в документации CloudPayments <a target="_blank" href="https://cloudpayments.ru/Docs/Kassa#data-format">https://cloudpayments.ru/Docs/Kassa#data-format</a>';
$_lang['setting_ms2_payment_cloudpayments_taxation_system']             = 'Система налогообложения';
$_lang['setting_ms2_payment_cloudpayments_taxation_system_desc']        = 'Возможные значения: 0-5. Более детальная информация в документации CloudPayments <a target="_blank" href="https://cloudpayments.ru/Docs/Directory#taxation-system">https://cloudpayments.ru/Docs/Directory#taxation-system</a>';
