...
$_lang['setting_ms2_payment_cloudpayments_skin']                        = 'Widget design';
$_lang['setting_ms2_payment_cloudpayments_skin_desc']                   = 'Widget design. Additional Information in CloudPayments documentation <a target="_blank" href="https://developers.cloudpayments.ru/#parametry">https://developers.cloudpayments.ru/#parametry</a>';
$_lang['setting_ms2_payment_cloudpayments_currency']                    = 'Currency';
$_lang['setting_ms2_payment_cloudpayments_currency_desc']               = 'Payment currency. Available values RUB/USD/EUR/GBP etc. All available values in CloudPayments documentation <a target="_blank" href="https://developers.cloudpayments.ru/#spisok-valyut">https://developers.cloudpayments.ru/#spisok-valyut</a>';
$_lang['setting_ms2_payment_cloudpayments_language']                    = 'Language';
$_lang['setting_ms2_payment_cloudpayments_language_desc']               = 'Example ru-RU, en-US etc. All available values in CloudPayments documentation <a target="_blank" href="https://developers.cloudpayments.ru/#lokalizatsiya-vidzheta">https://developers.cloudpayments.ru/#lokalizatsiya-vidzheta</a>';
...
$_lang['setting_ms2_payment_cloudpayments_vat_desc']                    = 'Available values: 20,10,0,110,120 or empty. Only for generate online check. More details in documentation CloudPayments <a target="_blank" href="https://developers.cloudpayments.ru/#znacheniya-stavki-nds">https://developers.cloudpayments.ru/#znacheniya-stavki-nds</a>';
$_lang['setting_ms2_payment_cloudpayments_vat_delivery']                = 'Vat for delivery';
$_lang['setting_ms2_payment_cloudpayments_vat_delivery_desc']           = 'Available values: 20,10,0,110,120 or empty. Only for generate online check. More details in documentation CloudPayments <a target="_blank" href="https://developers.cloudpayments.ru/#znacheniya-stavki-nds">https://developers.cloudpayments.ru/#znacheniya-stavki-nds</a>';
$_lang['setting_ms2_payment_cloudpayments_taxation_system']             = 'Taxation system';
$_lang['setting_ms2_payment_cloudpayments_taxation_system_desc']        = 'Available values: 0-5. More details in documentation CloudPayments <a target="_blank" href="https://developers.cloudpayments.ru/#sistemy-nalogooblozheniya">https://developers.cloudpayments.ru/#sistemy-nalogooblozheniya</a>';
