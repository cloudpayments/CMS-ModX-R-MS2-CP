# Данный модуль предоставляет виджет оплаты, который размещается на сайте. Оплата производится не покидая сайт на внешние страницы оплаты платежного шлюза.
